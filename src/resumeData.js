let resumeData = {
    ...
    "socialLinks":[
        {
            "name":"linkedin",
            "url":"https:www.linkedin.com/in/jawwadkhan77/",
    ...
    "work":[
        {
            "CompanyName":"Royal Canadian Mounted Police(RCMP) - IM/IT Branch",
            "specialization":"Next Generation Technology Analyst",
            "MonthOfLeaving":"Present",
            "YearOfLeaving":"",
            "Achievements":"Converted code base from AWS to Microsoft Azure, deployed elasticsearch on large database data, eased utilization of large scale federal database information into APIs used in applications used by everyday officer use"
        },
        {
